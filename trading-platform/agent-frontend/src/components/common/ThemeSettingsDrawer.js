    ...
    return (
        ...
        >
            ...
            <Offcanvas.Body className="p-4 theme-drawer-body">
                ...
                <div className="setting-item d-flex justify-content-between align-items-center mb-4">
                    <span className="setting-text">{t('multiple_tabs')}</span>
                    <Form.Check
                        type="switch"
                        checked={settings.multipleTabs}
                        onChange={() => handleToggle('multipleTabs')}
                        className="custom-switch"
                    />
                </div>

                <div className="setting-item d-flex justify-content-between align-items-center mb-4">
                    <span className="setting-text">{t('expand_one_level')}</span>
                    <Form.Check
                        type="switch"
                        checked={settings.expandOneLevel}
                        onChange={() => handleToggle('expandOneLevel')}
                        className="custom-switch"
                    />
                </div>

                {/* Menu Width */}
                <div className="setting-item d-flex justify-content-between align-items-center mb-4 mt-4">
                    <span className="setting-text">{t('menu_width')}</span>
                    <div className="number-input d-flex align-items-center">
                        <button className="num-btn border-end" onClick={() => handleWidthChange(-10)}>−</button>
                        <span className="num-display border-end border-start">{settings.menuWidth}</span>
                        <button className="num-btn border-start" onClick={() => handleWidthChange(10)}>+</button>
                    </div>
                </div>

                <div className="setting-item d-flex justify-content-between align-items-center mb-4">
                    <span className="setting-text">{t('show_logo')}</span>
                    <Form.Check
                        type="switch"
                ...
                <div className="setting-item d-flex justify-content-between align-items-center mb-4">
                    <span className="setting-text">{t('show_breadcrumbs')}</span>
                    <Form.Check
                        type="switch"
